...
const items = [
  { icon:Info,        color:"#f97316", title:"Nền Tảng Đăng Tin Trung Gian",
  ...
  { icon:Scale,       color:"#60a5fa", title:"Trách Nhiệm Pháp Lý",
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full mb-3"
            ...
            <Scale className="w-3.5 h-3.5" style={{ color: "#fb923c" }} />
            <span className="text-xs font-bold uppercase tracking-widest" style={{ color: "#fb923c" }}>Tuân Thủ Pháp Luật VN</span>
          </div>
          <h2 className="text-display-3 mb-3" style={{ fontFamily: "var(--font-gilroy),sans-serif" }}>
            <span style={{ color: "var(--fg)" }}>Điều Khoản </span>
            <span className="grad-orange">& Pháp Lý</span>
          </h2>
        </div>
        ...
        {/* Legal basis */}
        <div className="rounded-2xl p-5" style={{ background: "rgba(249,115,22,0.06)", border: "1px solid rgba(249,115,22,0.18)" }}>
          <div className="flex items-center gap-2 mb-3">
            <Shield className="w-4 h-4" style={{ color: "#fb923c" }} />
            <h3 className="text-sm font-semibold" style={{ color: "var(--orange3)" }}>Cơ Sở Pháp Lý Áp Dụng</h3>
          </div>
        ...
        <p className="text-center text-xs mt-5" style={{ color: "var(--fg3)" }}>
          Cập nhật: 05/2026 · Liên hệ pháp lý: <span style={{ color: "var(--orange3)" }}>legal@shopaccgame.net</span>
        </p>
      </div>
    </section>
  );
