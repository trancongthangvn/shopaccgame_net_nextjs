...
export const listings: Listing[] = [
  { id:"LMHT8425", game:"LMHT", gameKey:"lmht", title:"Acc LMHT Kim Cương 1 — 80 tướng + 15 skin legendary, email gốc", rank:"Kim Cương 1", price:"850.000", priceNum:850000, oldPrice:"1.200.000", views:"2.4k", favs:48, posted:"2 giờ trước", verified:true, tags:["80+ tướng","15 skin","Email gốc"], preview:"preview-lmht", color:"#3b82f6", accent:"#60a5fa", badge:"sale", description:"Acc LMHT chính chủ, đã chơi 5 năm, đầy đủ email gốc và SĐT. 80+ tướng sở hữu, 15 skin legendary (Pulsefire Ezreal, Elementalist Lux, DJ Sona...). Trang bị Rune mặc định + 15 trang đa dạng cho meta hiện tại. Đã xác minh 2FA, sẵn sàng chuyển nhượng full info.", seller:{ name:"GameStore247", rating:4.9, sales:142 } },
